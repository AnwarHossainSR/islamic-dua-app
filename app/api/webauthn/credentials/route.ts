...
import { deleteCredential, getUserCredentials } from '@/lib/webauthn/server'
...
export async function GET() {
  try {
    ...
    apiLogger.error('Failed to retrieve credentials', {
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    apiLogger.error('Failed to delete credential', {
      error: error instanceof Error ? error.message : 'Unknown error',
    })
