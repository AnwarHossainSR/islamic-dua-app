          ...
          <CardHeader className="space-y-3 sm:space-y-4">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
              <div className="flex-1 space-y-2">
                ...
                {dua.title_ar && <CardDescription className="text-base sm:text-lg">{dua.title_ar}</CardDescription>}
                {dua.category && (
          ...
          <CardContent className="space-y-4 sm:space-y-6">
            ...
            {dua.translation_en && (
              <div>
                ...
                <p className="break-words rounded-lg bg-muted/50 p-3 leading-relaxed sm:p-4">{dua.translation_en}</p>
              </div>
            )}
            ...
            {dua.reference && (
              <div>
                ...
                <p className="break-words text-sm text-muted-foreground sm:text-base">{dua.reference}</p>
              </div>
            )}
            ...
            {dua.fazilat && dua.fazilat.length > 0 && (
              <>
                <Separator />
                <div>
                  <h3 className="mb-3 text-lg font-semibold sm:mb-4 sm:text-xl">Fazilat (Virtues)</h3>
