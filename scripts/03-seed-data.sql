-- Heaven Rose Islamic - Seed Data
-- This script populates initial categories, tags, and sample duas

-- Insert Categories
INSERT INTO categories (name_bn, name_ar, name_en, slug, icon, display_order) VALUES
...
-- Insert Tags
INSERT INTO tags (name_bn, name_ar, name_en, slug) VALUES
...
SELECT 
  ...
  'সূরা বাকারা ২:২৫৫',
  true
FROM categories c WHERE c.slug = 'morning-evening' LIMIT 1;
...
SELECT 
  ...
  'বুখারী ও মুসলিম',
  true
FROM categories c WHERE c.slug = 'food' LIMIT 1;
...
-- Insert Dhikr Presets
INSERT INTO dhikr_presets (name_bn, name_ar, name_en, arabic_text, transliteration_bn, translation_bn, target_count, is_default, display_order) VALUES
